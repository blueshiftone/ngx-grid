...
export class IconsService {
  ...
  private _iconData = new Map<EGridIcon, string>([
    ...
    [ EGridIcon.CheckCircle, `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M32,64C14.36,64,0,49.64,0,32S14.36,0,32,0s32,14.36,32,32-14.36,32-32,32ZM32,3.37C16.21,3.37,3.37,16.21,3.37,32s12.84,28.63,28.63,28.63,28.63-12.84,28.63-28.63S47.79,3.37,32,3.37Z"/></svg>`],
    [ EGridIcon.CheckedCircle, `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64"><defs><style>.cls-1{fill:#fff;}.cls-2{fill:url(#linear-gradient);}</style><linearGradient id="linear-gradient" x1="32" y1="65" x2="32" y2="0" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#2799d4"/><stop offset="1" stop-color="#32abe6"/></linearGradient></defs><circle class="cls-2" cx="32" cy="32" r="32"/><path class="cls-1" d="M28.5,44.1l-9.58-9.24c-.38-.37-.4-.98-.02-1.37l2.64-2.74c.37-.38.98-.4,1.37-.02l5.52,5.33c.38.37.98.36,1.35-.01l13.87-13.87c.38-.38.99-.38,1.37,0l2.69,2.69c.38.38.38.99,0,1.37l-17.86,17.86c-.37.37-.97.38-1.35.01Z"/></svg>`],
    [ EGridIcon.Check, `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21"><polygon points="7.27 17.29 1.66 11.69 3.08 10.28 7.27 14.46 17.92 3.81 19.34 5.22 7.27 17.29"/></svg>`],
